...
const FAQ_BANK = [
  ...
  { id:'tocar-siguiente-recta', keywords:['tocar siguiente recta','boton tocar siguiente recta','como aparecen las rectas tangentes','se mueve la regla','regla que se desliza','por que se mueve la recta'],
  ...
  { id:'verificar-funcion-pendiente', keywords:['verificar funcion pendiente','como formulo la funcion pendiente','que es m=4x-1','formula de la pendiente','m de x','funcion pendientes'],
    answer:'Cuando la suma Y la sucesión quedan correctas, se desbloquea el tercer campo: ahí formulas la función $m(x)$ que da la pendiente para cualquier $x$ — la derivada, en forma cerrada. Escríbela como $m=...$, $m(x)=...$, o solo la expresión, usando $x$ (o $n$, son intercambiables) como variable; debe ser un polinomio. El botón "Verificar función" la compara, coeficiente por coeficiente y de forma EXACTA, contra la derivada real de tu función graficada.' },
  { id:'hallazgos-pendiente-sumas', keywords:['tabla de hallazgos pendiente','hallazgos pendiente','donde quedan mis respuestas de pendiente','historial de pendiente'],
    answer:'Cada vez que formulas correctamente la función $m(x)$ de una situación, se agrega una fila a la tabla "Hallazgos (Pendiente)": la función que graficaste, tu suma de diferencias, tu sucesión de pendientes, y la función $m(x)$ que encontraste — tal como lo escribiste. Es un historial que no se borra al graficar una función nueva, para que puedas repasar tus respuestas de toda la sesión.' },
];
