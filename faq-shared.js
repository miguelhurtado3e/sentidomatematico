...
const FAQ_BANK = [
  ...
  { id:'comando-combinar', keywords:['combinar','comando combinar','que hace combinar','una sola fraccion'],
  ...
  { id:'comando-factorizar', keywords:['factorizar','comando factorizar','que hace factorizar','factor comun'],
